...
audio = (AudioFileClip("/code/app/frontier.mp4")
        .subclip((4,7), (4,18))
        .audio_fadein(1)
        .audio_fadeout(1))
...
clip = (VideoFileClip("/code/app/knights.mp4", audio=False)
...
final.write_videofile("/code/app/dancing_knights.mp4", fps=clip.fps,
